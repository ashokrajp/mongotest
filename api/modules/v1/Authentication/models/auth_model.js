...
const userModel = require('../../../schema/tbl_product');
const ecardModel = require('../../../schema/tbl_brand');
const cmsModel = require('../../../schema/tbl_banner');
const contactModel = require('../../../schema/tbl_category');
const moment = require('moment');
const common = require('../../../../config/common');
const otpTemplate = require('../../../../config/template');
const cryptoLib = require('cryptlib');
const { AwsInstance } = require('twilio/lib/rest/accounts/v1/credential/aws');
const { brandListing } = require('../controller/auth_controller');
